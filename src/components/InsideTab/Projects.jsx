      ...
      <div className="aboutme-container flex flex-col gap-8 overflow-y-scroll">
        <div className="aboutme-bottom flex flex-col gap-3">
          ...
          <span>
            ...
            policymakers make informed decisions, promoting a cleaner, healthier
            future.
            <br />
          </span>
          ...
          <span>
            ...
            engaging audio, enabling users to consume information effortlessly.
            It utilizes web scraping to extract content, summarization to retain
            key details, and text-to-speech conversion for high-quality audio
            output. The system follows a microservices architecture for
            scalability and employs Redis for caching and MongoDB for data
            storage. Users simply provide a URL to receive an audio file ready
            for playback.
            <br />
            <br />
          ...
          <span>
            The project focused on developing an interactive e-commerce platform
            that combines traditional fixed-price purchases with a bidding
            process for selling and buying products. This unique feature aims to
            enhance user engagement by offering more flexibility in
            transactions.
            <br />
            <br />
            ...
            experience, encouraging interaction between buyers and sellers while
            increasing user participation and satisfaction.
          </span>
          <a
